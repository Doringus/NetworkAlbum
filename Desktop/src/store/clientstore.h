...
public:
    ...
    Q_PROPERTY(bool showConnectButton READ getShowConnectButton NOTIFY showConnectButtonChanged)
...
private:
    ...
    void processReceiveAlbumInfo(QString albumName, double albumSize);
...
private:
    ...
    QString m_AlbumName;
    double m_AlbumSize;
    bool m_ConnectButtonVisibility = true;
};
