...
ApplicationWindow {
    ...
    GetImagesPopup {
        id: getImagesPopup
        visible: RootStore.showGetImagesPopup
        onAboutToHide: ActionProvider.hideGetImagesPopup()
        albumName: ClientStore.albumName
        albumSize: ClientStore.albumSize
        onClicked: ActionProvider.getImages()
    }
